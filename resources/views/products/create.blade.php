<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href="{{ route('panel.products.index') }}">&laquo; back</a> / {{ __('Add product') }}
        </h2>
    </x-slot>
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <form method="POST" action="{{ route('panel.products.store') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="price" class="block mt-1 w-full" type="number" step="0.01" name="price" :value="old('price')" required autocomplete="price" />
